...
HTMLHEREDOC
    my $new = <<'HTMLHEREDOC';
<br /><a href="http://clip.livedoor.com/page/<$mt:var name="entry_permalink"$>"><img src="http://image.clip.livedoor.com/counter/<$mt:var name="entry_permalink"$>" /></a>
HTMLHEREDOC
    $$tmpl =~ s!($old)!$1$new!;
});
...
HTMLHEREDOC
    ...
    $old = quotemeta ($old);
    my $new = <<'HTMLHEREDOC';
&nbsp;<a href="http://clip.livedoor.com/page/<$MTEntryPermalink$>"><img src="http://image.clip.livedoor.com/counter/<$MTEntryPermalink$>" /></a>
HTMLHEREDOC
    $$tmpl =~ s!($old)!$1$new!;
});
